...
SYNC is a clean, bold, product-focused site template with a homepage, subpage, navigation, and footer. It showcases a company offering speakers, headphones and other audio gear. This demo site is built to showcase XM Cloud capabilities using the Content SDK.
